...
export default function EventCardLarge({ event }: { event: any }) {
  ...
  return (
    <a
      ...
      target="_blank"
      className="block col-span-12 h-[300px]"
    >
      <article className="group flex h-full w-full rounded-3xl overflow-hidden shadow-lg transition-all duration-300 hover:-translate-y-1 relative">
        ...
        {/* DATA */}
        <div 
          className="w-80 bg-black/40 backdrop-blur-md flex flex-col items-center justify-center shrink-0 relative z-10"
        >
          <span 
        ...
        {/* CONTEÚDO */}
        <div className="relative flex-1 overflow-hidden flex justify-between">
          <img
            src={event.image_url}
          ...
          <div className="relative z-10 h-full p-5 flex flex-col justify-center text-white ">
            ...
            <h3 className="text-4xl font-bold mt-2 line-clamp-2">
              {event.title}
            </h3>
